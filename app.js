/* SOLICITOR Exam Simulator, Application Logic */

const ACCESS_CODE  = "SOLICITOR9000";
const EXAM_SECONDS = 16200;
const PASSING_PCT  = 70;
const STORAGE_KEY  = "solicitor_exam_state_v1";
...
const DOMAIN_LABELS = {"real_estate_transactions_and_closing": "Real Estate Transactions and Closing", "title_registration_and_due_diligence": "Title Registration and Due Diligence", "mortgages_liens_and_real_estate_remedies": "Mortgages Liens and Real Estate Remedies", "wills_and_estate_planning": "Wills and Estate Planning", "estate_administration_trusts_and_taxation": "Estate Administration Trusts and Taxation", "business_structures_and_corporate_law": "Business Structures and Corporate Law", "commercial_transactions_and_secured_lending": "Commercial Transactions and Secured Lending", "professional_responsibility_and_ethics": "Professional Responsibility and Ethics", "practice_management_fees_and_trust_accounting": "Practice Management Fees and Trust Accounting"};  // maps domain key -> human-readable label for display
